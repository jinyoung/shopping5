...
public class DBConfiguration {
    ...
    @Bean
    @Primary
    public SqlSessionFactory sqlSessionFactoryMain(
        @Autowired @Qualifier("mariadbDataSource") DataSource dataSource
    ) throws Exception {
        org.apache.ibatis.session.Configuration configuration =
            this.getMybatisConfig();
    ...
    @Primary
    public SqlSession sqlSessionMain(
        @Autowired @Qualifier("sqlSessionFactoryMain") SqlSessionFactory factory
    ) {
