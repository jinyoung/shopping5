...
public class KafkaConfiguration {
            ...
            new ErrorHandler() {
                ...
                public void handle(
                    ...
                    int partition = Integer.valueOf(
                        s.split("-")[1].split(" at")[0]
                    );
                    System.out.println(
                        "[Warn] Unhandled Object from Kafka broker Offset at " +
                        offset
                    );
    ...
    public ProducerFactory<Object, Object> producerFactory() {
        return new DefaultKafkaProducerFactory(
            KafkaProperties.getProducerProperties(bootstrapServers)
        );
    }
    ...
    public ConsumerFactory<Object, Object> consumerFactory() {
        return new DefaultKafkaConsumerFactory(
            KafkaProperties.getConsumerProperties(bootstrapServers)
        );
    }
}
