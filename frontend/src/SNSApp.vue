            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="vehicles"
                        to="/vihiclemanagements/vehicles"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="pointAccumulations"
                        to="/points/pointAccumulations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                key: 'vehicles', 
                route: '/vihiclemanagements/vehicles',
                ImageUrl: '',
            },
            { 
                title: '사용자', 
                description: '사용자 정보를 관리하는 Aggregate', 
                key: 'users', 
                route: '/usermgmts/users',
                ImageUrl: '',
            },
            { 
                title: '포인트적립', 
                description: '포인트를 적립하는 기능을 처리하는 Aggregate', 
                key: 'pointAccumulations', 
                route: '/points/pointAccumulations',
                ImageUrl: '',
            },
