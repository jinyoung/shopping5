<template>
    <div style="max-height:80vh;">
        ...
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
            ...
            <v-btn @click="updateUserDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('Admin')">
                <v-icon small>mdi-minus-circle-outline</v-icon>사용자 수정
            </v-btn>
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','email','password','주소',]" />
            ...
            <wj-flex-grid-column binding="주소" header="주소" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
...
export default {
    ...
    methods:{
        updateUser(params){
            try{
                this.repository.invoke(this.getSelectedItem(), "/users/{userId}", params)
